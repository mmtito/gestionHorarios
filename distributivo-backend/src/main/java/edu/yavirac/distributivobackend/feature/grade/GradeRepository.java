...
import edu.yavirac.distributivobackend.feature.subject.SubjectSelect;
...
public interface GradeRepository extends CrudRepository<Grade, Long> {
	...
	final String GET_SELECT_PAGEABLE = "select id, name from grade where status=true and name ilike '%'|| :name  ||'%' LIMIT 20";
    ...
    List<GradeSelect> findNameSelect(@Param("name") String name);
