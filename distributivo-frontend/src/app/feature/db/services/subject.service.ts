...
export class SubjectService {
  ...
  constructor(
    ...
    public findById (id : number): Observable<Subject>{
      return this.http.get<Subject>(this.url+"/findById/"+id , this.HttpOptions)
    }
    ...
    public findByName (term : string) : Observable<Subject[]>{
      return this.http.get<Subject[]>(this.url + "/findByName/" + term, this.HttpOptions)
    }
}
