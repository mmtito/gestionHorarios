...
@Component({
  selector: 'bottom-sheet-overview-classroom',
  templateUrl: './bottom-sheet-overview-classroom.html',
  styleUrls: []
})
export class BottomSheetOverviewClassroom{
  ...
  downloadFile() {
    ...
    this.loading = true;                               
    this.classroomService.downloadFile().subscribe(
        {
          next : (res)=>{
            this.loading =false;
 ...
 */
@Component({
  selector: 'bottom-sheet-classroom',
  templateUrl: './bottom-sheet-classroom.html',
})
export class BottomSheetClassroom {
  constructor(private _bottomSheet: MatBottomSheet) {}

  openBottomSheet(): void {
    this._bottomSheet.open(BottomSheetOverviewClassroom);
  }
}